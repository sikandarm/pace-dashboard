...
import { deleteTasks, getRejectionReasons, getSingleTasks, getTasks } from '../../feature/tasksSlice';
...
export default function Tasks(props) {
  ...
  const { tasks, isTaskLoading, rejectionReasons } = useSelector((state) => state.tasksSlice);
  ...
  function applySortFilter(array, comparator, query) {
    ...
    if (query) {
      return filter(tasks, (_inv) => _inv.pmkNumber.toLowerCase().indexOf(query.toLowerCase()) !== -1);
    }
                ...
                <Table>
                  ...
                  <TableBody>
                    {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                      const { id, pmkNumber, heatNo, description, status, image } = row;
                      return (
                        <TableRow hover key={id} tabIndex={-1}>
                          <TableCell align="left">
                            {image ? <img alt="task" style={{ width: '50px', height: '40px' }} src={image} /> : '_'}
                          </TableCell>
                          ...
                          <TableCell align="left">{description ? description : '_'}</TableCell>
                          <TableCell align="left">
                            <Label
                              color={
                                status === 'approved'
